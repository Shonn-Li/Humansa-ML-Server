                ...
                if subtitle_info and isinstance(subtitle_info, dict):
                    ...
                    if subtitles:
                        for i, subtitle in enumerate(subtitles):
                            ...
                            print(f"      Language: {subtitle.get('lan_doc', subtitle.get('lan', 'unknown'))}")
                            print(f"      URL: {subtitle.get('subtitle_url', 'N/A')}")
                    else:
                        print("    No subtitles found in response")
                else:
                    print(f"    Unexpected subtitle_info format: {subtitle_info}")
