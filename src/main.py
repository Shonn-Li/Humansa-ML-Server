...
logger.info(f"DB_ACTIVE_DATABASE: {os.getenv('DB_ACTIVE_DATABASE', 'NOT SET')}")
logger.info(f"OPENAI_API_KEY: {'SET' if os.getenv('OPENAI_API_KEY') else 'NOT SET'}")
logger.info(f"EMBEDDING_DEV: {'SET' if os.getenv('EMBEDDING_DEV') else 'NOT SET'}")
logger.info("================================")
...
def register_original_endpoints(app):
    ...
    async def analyze_link_endpoint():
        """Link analysis endpoint - ORIGINAL IMPLEMENTATION"""
...
if __name__ == "__main__":
    ...
    logger.info("   - /analyze_link endpoint")
