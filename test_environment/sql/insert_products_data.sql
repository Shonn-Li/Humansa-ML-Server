-- Insert product data matching existing schema
INSERT INTO humansa_products (product_id, name, category_id, price, original_price, discount_tag, description, benefits, usage_instructions, suitable_for, stock_status, is_featured) VALUES
-- 维生素类
...
-- Insert package data
INSERT INTO humansa_product_packages (package_id, name, description, tags, total_value, savings_amount, included_items, target_audience) VALUES
...
UNION ALL
SELECT 'Packages' as entity, COUNT(*) as count FROM humansa_product_packages;