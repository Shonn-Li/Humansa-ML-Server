...
def register_admin_endpoints(app):
    ...
    logger.warning("⚠️  Legacy admin/URL embedding endpoints temporarily disabled")
    logger.warning("    They have import dependencies on old modules")
    logger.warning("    New V2 equivalents will be implemented in chat/endpoints/")
...
if __name__ == "__main__":
    ...
    logger.info("   - /v2/chat/completions - Modular chat with citations & streaming")
    ...
    logger.info("   - /v1/embeddings/url/* - Legacy URL embeddings (needs V2 implementation)")
    logger.info("   - /admin/embedding/* - Legacy admin controls (needs V2 implementation)")
    logger.info("")
