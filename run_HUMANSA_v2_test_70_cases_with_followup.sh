...
# Function to test API with follow-up conversations
test_api_followup() {
    local test_num=$1
    local user_id=$2
...
EOF
            ...
            # Extract clean response (remove thinking markers if present)
...
echo "# HUMANSA V2 - 70 Test Cases with Follow-up Conversations" > "$RESULTS_FILE"
